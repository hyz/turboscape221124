...
impl<'a> Monster<'a> {
    ...
    pub fn unpack(&self) -> MonsterT {
        ...
        let path = self.path().map(|x| x.iter().map(|t| t.unpack()).collect());
        MonsterT {
            pos,
            mana,
            hp,
    ...
    pub fn weapons(
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Weapon>>,
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Weapon>>,
            >>("weapons", Self::VT_WEAPONS, false)?
            .visit_union::<Equipment, _>(
                "equipped_type",
                Self::VT_EQUIPPED_TYPE,
                "equipped",
                Self::VT_EQUIPPED,
                false,
                |key, v, pos| match key {
...
pub struct MonsterArgs<'a> {
    ...
    pub color: Color,
    pub weapons: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Weapon<'a>>>>,
    >,
...
impl<'a: 'b, 'b> MonsterBuilder<'a, 'b> {
    ...
    pub fn add_equipped_type(&mut self, equipped_type: Equipment) {
        self.fbb_
            .push_slot::<Equipment>(Monster::VT_EQUIPPED_TYPE, equipped_type, Equipment::NONE);
    }
    #[inline]
