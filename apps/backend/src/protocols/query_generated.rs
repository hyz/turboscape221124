...
impl<'a> Request<'a> {
  ...
  pub fn method(&self) -> Method {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Method>(Request::VT_METHOD, Some(Method::Method_)).unwrap()}
  }
  #[inline]
  pub fn url(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Request::VT_URL, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b> RequestBuilder<'a, 'b> {
  ...
  pub fn add_method(&mut self, method: Method) {
    self.fbb_.push_slot::<Method>(Request::VT_METHOD, method, Method::Method_);
  }
  #[inline]
  pub fn add_url(&mut self, url: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Request::VT_URL, url);
  }
  #[inline]
...
impl<'a> Response<'a> {
  ...
  pub fn content(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Response::VT_CONTENT, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b> ResponseBuilder<'a, 'b> {
  ...
  pub fn add_content(&mut self, content: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Response::VT_CONTENT, content);
  }
  #[inline]
...
impl<'a> Context<'a> {
  ...
  pub fn path(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Context::VT_PATH, None)}
  }
  #[inline]
  pub fn uuid(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Context::VT_UUID, None)}
  }
  #[inline]
  pub fn index(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Context::VT_INDEX, None)}
  }
  #[inline]
  pub fn origin(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Context::VT_ORIGIN, None)}
  }
}
...
impl<'a: 'b, 'b> ContextBuilder<'a, 'b> {
  ...
  pub fn add_path(&mut self, path: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Context::VT_PATH, path);
  }
  #[inline]
  pub fn add_uuid(&mut self, uuid: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Context::VT_UUID, uuid);
  }
  #[inline]
  pub fn add_index(&mut self, index: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Context::VT_INDEX, index);
  }
  #[inline]
  pub fn add_origin(&mut self, origin: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Context::VT_ORIGIN, origin);
  }
  #[inline]
...
impl<'a> Query<'a> {
  ...
  #[inline]
  pub fn context(&self) -> Option<Context<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Context>>(Query::VT_CONTEXT, None)}
  }
  #[inline]
  pub fn request(&self) -> Option<Request<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Request>>(Query::VT_REQUEST, None)}
  }
  #[inline]
  pub fn response(&self) -> Option<Response<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Response>>(Query::VT_RESPONSE, None)}
  }
}
...
impl flatbuffers::Verifiable for Query<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<Context>>("context", Self::VT_CONTEXT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<Request>>("request", Self::VT_REQUEST, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<Response>>("response", Self::VT_RESPONSE, false)?
     .finish();
    Ok(())
  }
}
pub struct QueryArgs<'a> {
    pub context: Option<flatbuffers::WIPOffset<Context<'a>>>,
...
impl<'a: 'b, 'b> QueryBuilder<'a, 'b> {
  #[inline]
  pub fn add_context(&mut self, context: flatbuffers::WIPOffset<Context<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Context>>(Query::VT_CONTEXT, context);
  }
  #[inline]
  pub fn add_request(&mut self, request: flatbuffers::WIPOffset<Request<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Request>>(Query::VT_REQUEST, request);
  }
  #[inline]
  pub fn add_response(&mut self, response: flatbuffers::WIPOffset<Response<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Response>>(Query::VT_RESPONSE, response);
  }
  #[inline]
...
pub fn size_prefixed_root_as_query(buf: &[u8]) -> Result<Query, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_query_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<Query<'a>>) {
